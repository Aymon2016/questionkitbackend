...
class QuestionCollection {
    ...
    async create(serial, classes, bookName, chapter, type, question, question_i, question_ii, question_iii, option_a, option_b, option_c, option_d, answer, filePath) {

        const oneQuestion = new Question(serial, classes, bookName, chapter, type, question, question_i, question_ii, question_iii, option_a, option_b, option_c, option_d, answer);
